...
export function OptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Options {
    ...
    return {
        ...
        'doNotAddWatermark': !exists(json, 'do_not_add_watermark') ? undefined : json['do_not_add_watermark'],
        ...
        'upscalerForImg2img': !exists(json, 'upscaler_for_img2img') ? undefined : NullFromJSON(json['upscaler_for_img2img']),
        'faceRestorationModel': !exists(json, 'face_restoration_model') ? undefined : NullFromJSON(json['face_restoration_model']),
        ...
        'sdVaeAsDefault': !exists(json, 'sd_vae_as_default') ? undefined : json['sd_vae_as_default'],
        ...
        'extraNetworksDefaultView': !exists(json, 'extra_networks_default_view') ? undefined : json['extra_networks_default_view'],
        ...
        'quicksettings': !exists(json, 'quicksettings') ? undefined : json['quicksettings'],
        ...
        'loraApplyToOutputs': !exists(json, 'lora_apply_to_outputs') ? undefined : json['lora_apply_to_outputs'],
    };
}
...
export function OptionsToJSON(value?: Options | null): any {
    ...
    return {
        ...
        'upscaler_for_img2img': NullToJSON(value.upscalerForImg2img),
        'face_restoration_model': NullToJSON(value.faceRestorationModel),

...
export function ControlNetUnitRequestFromJSON(
  json: any
): ControlNetUnitRequest {
  return ControlNetUnitRequestFromJSONTyped(json, false);
}

export function ControlNetUnitRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    resizeMode: !exists(json, "resize_mode")
      ? undefined
      : ControlnetResizeModeFromJSON(json["resize_mode"]),
    lowvram: !exists(json, "lowvram") ? undefined : json["lowvram"],
    processorRes: !exists(json, "processor_res")
      ? undefined
      : json["processor_res"],
    ...
    guidanceStart: !exists(json, "guidance_start")
      ? undefined
      : json["guidance_start"],
    guidanceEnd: !exists(json, "guidance_end")
      ? undefined
      : json["guidance_end"],
    control_mode: !exists(json, "control_mode")
      ? undefined
      : json["control_mode"],
    pixelPerfect: !exists(json, "pixel_perfect")
      ? undefined
      : json["pixel_perfect"],
  };
}

export function ControlNetUnitRequestToJSON(
  value?: ControlNetUnitRequest | null
): any {
  if (value === undefined) {
    return undefined;
  }
